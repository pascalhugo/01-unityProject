...
public class AI_ControllerEnemy : MonoBehaviour {
	...
	private MinionEnemy[] minionsEnemy;

	public static AI_ControllerEnemy Instance { get; private set; }
	...
	private void SendMinionsFight() {
		foreach(MinionEnemy minion in minionsEnemy) {
			minion.Fight();
		}
	}
	...
	private IEnumerator ReleaseWave() {
		yield return 0;
		minionsEnemy = FindObjectsOfType<MinionEnemy>();
		SendMinionsFight();
	}
